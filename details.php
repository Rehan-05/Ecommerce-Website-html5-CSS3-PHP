        ...
        <div class="main_wrapper">
            ...
            <div class="menuebar">
                <ul id="menue" style="list-style:none;">
                    ...
                    <li class=" nav-item"><a href="customers/my_account.ph">My Account</a></li>
            ...
            <div class=" content_wrapper">
                ...
                <div id="content_area">
                    ...
                    <div id="product_box">
                     ...
                     <img src='admin-area/product_img/$pro_image' width='400px' height='300px' >
                     <p><b>$pro_price</b></p>
                     <p>$pro_desc</p>
                     <a href='index.php ' style='float:left;' class='btn'>Go back</a>
